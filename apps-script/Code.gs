...
function sendWelcomeEmail(data) {
  ...
  var htmlBody =
    ...
    '<p style="color: #bfdbfe; margin: 8px 0 0; font-size: 14px;">Plataforma de Capacitacion</p>' +
    "</div>" +
    '<div style="background-color: #f8fafc; padding: 24px; border: 1px solid #e2e8f0; border-top: none; border-radius: 0 0 8px 8px;">' +
    "<p>Hola <strong>" +
    data.firstName +
    "</strong>,</p>" +
    "<p>Te damos la bienvenida a <strong>HuAcademy</strong>, nuestra plataforma de capacitacion. A continuacion encontraras tus datos de acceso:</p>" +
    ...
    "<li>Tambien podes acceder desde el navegador en <a href='https://app.humand.co'>app.humand.co</a></li>" +
    "<li>Busca la comunidad <strong>HuAcademy</strong></li>" +
    "<li>Ingresa con tu usuario y contrasena</li>" +
    "<li>Te recomendamos cambiar tu contrasena en el primer ingreso</li>" +
    "</ol>" +
    '<p style="color: #64748b; font-size: 12px; margin-top: 24px;">Este es un correo automatico. Si tenes alguna consulta, contacta a tu referente en Humand.</p>' +
    "</div>" +
    "</div>";
